    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true) //Бесконечный цикл для того чтобы игра не закрывалась
            {
                ...
                AutoInput(keyRandom3, ref enemy3X, ref enemy3Y, map);
                ...
                Console.Write("Наберите 200 очков");
                ...
                Console.WriteLine($"Рандом: {keyRandom3}");
                ...
                if (map[enemyX, enemyY] == map[pacmanX, pacmanY] || map[enemy2X, enemy2Y] == map[pacmanX, pacmanY] || map[enemy3X, enemy3Y] == map[pacmanX, pacmanY])
                {
                    Console.Clear();
